...
var utils = require('maomaoframework-util');

var mmserver = require('mmserver-client').hdpserver;
var AppService = require('mmserver/AppService.js');
var SSHServerService = require('mmserver/SSHServerService.js');
 ...
 * 创建一个新的应用
 */
ConsoleActions.prototype.app_create = function(req, res){
    // 接收上传的文件，并解压缩
}
 ...
 *获取全部的应用
 */
ConsoleActions.prototype.data_applist = function(req, res){
  // 查询全部的应用
    var app = mmserver.getApp("master");
 ...
 *获取全部的应用
 */
ConsoleActions.prototype.app_detail = function(req, res){
 ...
 * 提交一个应用实例
 */
ConsoleActions.prototype.data_commitInstance = function(req, res){
 ...
 *获取一个应用的运行实例
 */
ConsoleActions.prototype.data_instancelist = function(req, res){
  // 查询全部的应用
    var app = mmserver.getApp("master");
    app.getService("AppService", AppService).then(function(service){
        service.getServerInfo().then(function(result){
            res.json(result);
        });
    });
}
 ...
 *　启动一个应用实例
 */
ConsoleActions.prototype.data_startup = function(req, res){
	var appid = utils.getParam(req, "appid");
 ...
 * 停止一个应用实例
 */
ConsoleActions.prototype.data_shutdown = function(req, res){
	var appid = utils.getParam(req, "appid");
	var insid = utils.getParam(req, 'insid');
 ...
 * 删除一个应用实例
 */
ConsoleActions.prototype.data_undeploy = function(req, res){
	var appid = utils.getParam(req, "appid");
	var insid = utils.getParam(req, 'insid');
 ...
 * 服务器管理主界面
 */
ConsoleActions.prototype.page_server_index = function(req, res){
	// 检查文件是否存在，如果不存在，则创建
 ...
 * 提交服务器信息
 */
ConsoleActions.prototype.data_commitServer = function(req, res){
 ...
 * 删除服务器信息
 */
ConsoleActions.prototype.data_removeServer = function(req, res){
 ...
 * 服务器管理主界面
 */
ConsoleActions.prototype.data_loadServers = function(req, res){
	// 读取json文件
	var app = mmserver.getApp("master");
    app.getService("SSHServerService", SSHServerService).then(function(service){
