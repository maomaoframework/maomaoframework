...
public final class AppServicePrxHelper extends Ice.ObjectPrxHelperBase implements AppServicePrx
{
    ...
    private static final String __getHdpServerInfo_name = "getHdpServerInfo";

    public String getHdpServerInfo()
    {
        return getHdpServerInfo(null, false);
    }

    public String getHdpServerInfo(java.util.Map<String, String> __ctx)
    {
        return getHdpServerInfo(__ctx, true);
    }

    private String getHdpServerInfo(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        __checkTwowayOnly(__getHdpServerInfo_name);
        return end_getHdpServerInfo(begin_getHdpServerInfo(__ctx, __explicitCtx, true, null));
    }

    public Ice.AsyncResult begin_getHdpServerInfo()
    {
        return begin_getHdpServerInfo(null, false, false, null);
    }

    public Ice.AsyncResult begin_getHdpServerInfo(java.util.Map<String, String> __ctx)
    {
        return begin_getHdpServerInfo(__ctx, true, false, null);
    }

    public Ice.AsyncResult begin_getHdpServerInfo(Ice.Callback __cb)
    {
        return begin_getHdpServerInfo(null, false, false, __cb);
    }

    public Ice.AsyncResult begin_getHdpServerInfo(java.util.Map<String, String> __ctx, Ice.Callback __cb)
    {
        return begin_getHdpServerInfo(__ctx, true, false, __cb);
    }
    ...
    public Ice.AsyncResult begin_getHdpServerInfo(IceInternal.Functional_GenericCallback1<String> __responseCb, 
                                                  IceInternal.Functional_GenericCallback1<Ice.Exception> __exceptionCb)
    {
        return begin_getHdpServerInfo(null, false, false, __responseCb, __exceptionCb, null);
    }
    ...
    public Ice.AsyncResult begin_getHdpServerInfo(IceInternal.Functional_GenericCallback1<String> __responseCb, 
                                                  ...
                                                  IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_getHdpServerInfo(null, false, false, __responseCb, __exceptionCb, __sentCb);
    }
    ...
    public Ice.AsyncResult begin_getHdpServerInfo(java.util.Map<String, String> __ctx, 
                                                  ...
                                                  IceInternal.Functional_GenericCallback1<Ice.Exception> __exceptionCb)
    {
        return begin_getHdpServerInfo(__ctx, true, false, __responseCb, __exceptionCb, null);
    }
    ...
    public Ice.AsyncResult begin_getHdpServerInfo(java.util.Map<String, String> __ctx, 
                                                  ...
                                                  IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_getHdpServerInfo(__ctx, true, false, __responseCb, __exceptionCb, __sentCb);
    }

    private Ice.AsyncResult begin_getHdpServerInfo(java.util.Map<String, String> __ctx, 
                                                   boolean __explicitCtx, 
                                                   boolean __synchronous, 
                                                   IceInternal.Functional_GenericCallback1<String> __responseCb, 
                                                   IceInternal.Functional_GenericCallback1<Ice.Exception> __exceptionCb, 
                                                   IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_getHdpServerInfo(__ctx, __explicitCtx, __synchronous, 
                                      new IceInternal.Functional_TwowayCallbackArg1<String>(__responseCb, __exceptionCb, __sentCb)
                                          {
                                              public final void __completed(Ice.AsyncResult __result)
                                              {
                                                  AppServicePrxHelper.__getHdpServerInfo_completed(this, __result);
                                              }
                                          });
    }
    ...
    private Ice.AsyncResult begin_getHdpServerInfo(java.util.Map<String, String> __ctx, 
                                                   ...
                                                   IceInternal.CallbackBase __cb)
    {
        __checkAsyncTwowayOnly(__getHdpServerInfo_name);
        IceInternal.OutgoingAsync __result = getOutgoingAsync(__getHdpServerInfo_name, __cb);
        try
        {
            __result.prepare(__getHdpServerInfo_name, Ice.OperationMode.Normal, __ctx, __explicitCtx, __synchronous);
    ...
    public String end_getHdpServerInfo(Ice.AsyncResult __iresult)
    {
        IceInternal.OutgoingAsync __result = IceInternal.OutgoingAsync.check(__iresult, this, __getHdpServerInfo_name);
        try
        {
            if(!__result.__wait())
            {
    ...
    static public void __getHdpServerInfo_completed(Ice.TwowayCallbackArg1<String> __cb, Ice.AsyncResult __result)
    {
        com.maomao.server.manager.idl.AppServicePrx __proxy = (com.maomao.server.manager.idl.AppServicePrx)__result.getProxy();
        String __ret = null;
        try
        {
            __ret = __proxy.end_getHdpServerInfo(__result);
        }
        catch(Ice.LocalException __ex)
        {
            __cb.exception(__ex);
